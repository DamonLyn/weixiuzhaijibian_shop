package cn.figo.weixiuzhaijibian.shop.service;
...
import cn.figo.weixiuzhaijibian.shop.MainActivity;
import cn.figo.weixiuzhaijibian.shop.R;
import cn.figo.weixiuzhaijibian.shop.api.Configs;
import cn.figo.weixiuzhaijibian.shop.callback.ICallbackResult;
import cn.figo.weixiuzhaijibian.shop.utils.StringUtils;
...
public class DownloadService extends Service {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				if (rate < 100) {
					...
					mNotification.setLatestEventInfo(mContext, "下載完成",
							"文件已下載完畢", contentIntent);
	...
	private void setUpNotification() {
		...
		mNotification = builder.setContentTitle(tickerText).setSmallIcon(icon)
				.build();
		// 放置在"正在运行"栏目中
